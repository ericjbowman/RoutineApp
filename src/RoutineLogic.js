...
class RoutineLogic extends Component {
  ...
  //
  // componentDidMount () {
  //   this.setState({ routines: completedRoutines })
  // }
  ...
  render () {
    ...
    const Wave1 = function (core1, core2, core3, core4, core5, core6, oblique1, oblique2,
      ...
      this.week2 = {
        ...
        day2: new DayAStatic2('Day 2', 'Light', antOhp2, antOhp2Max, 0.5, 0.6, 0.7, 15, 10, 8, ohp2, ohp2Max, oblique2, 'Reps', antBench, 5, null, 0.7, 5, bench, benchMax, oblique1, 'Endurance', antOhp3, 4, null, 0.6, 8, ohp3, ohp3Max, oblique3),
    ...
    const Wave2 = function (core1, core2, core3, core4, core5, core6, oblique1, oblique2,
      ...
      this.week2 = {
        ...
        day2: new DayAStatic2('Day 2', 'Light', antOhp2, antOhp2Max, 0.55, 0.65, 0.75, 12, 9, 7, ohp2, ohp2Max, oblique2, 'Reps', antBench, 5, null, 0.75, 5, bench, benchMax, oblique1, 'Endurance', antOhp3, 4, null, 0.65, 8, ohp3, ohp3Max, oblique3),
    ...
    const Wave3 = function (core1, core2, core3, core4, core5, core6, oblique1, oblique2,
      ...
      this.week2 = {
        ...
        day2: new DayAStatic2('Day 2', 'Light', antOhp2, antOhp2Max, 0.6, 0.7, 0.8, 10, 8, 6, ohp2, ohp2Max, oblique2, 'Reps', antBench, 5, null, 0.8, 5, bench, benchMax, oblique1, 'Endurance', antOhp3, 4, null, 0.7, 8, ohp3, ohp3Max, oblique3),
    ...
    const Wave4 = function (core1, core2, core3, core4, core5, core6, oblique1, oblique2,
      ...
      this.week2 = {
        ...
        day2: new DayAStatic2('Day 2', 'Light', antOhp2, antOhp2Max, 0.65, 0.75, 0.85, 9, 7, 4, ohp2, ohp2Max, oblique2, 'Reps', antBench, 5, null, 0.85, 5, bench, benchMax, oblique1, 'Endurance', antOhp3, 4, null, 0.75, 8, ohp3, ohp3Max, oblique3),
